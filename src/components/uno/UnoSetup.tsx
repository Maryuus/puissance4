...
export function UnoSetupUI({ onJoined, onBack, createRoom, joinRoom, loading, error }: UnoSetupUIProps) {
  ...
  return (
    ...
    >
      ...
      <h2 className="setup-title">UNO — En ligne</h2>
      <p className="setup-subtitle">2 à 10 joueurs</p>
          ...
          >
            {!createdCode ? (
              ...
              >
                ...
                {copied && (
                  <p className="text-green-400 text-xs mt-1">Copié !</p>
                )}
                <div className="waiting-indicator mt-3">
                  <div className="waiting-dots"><span /><span /><span /></div>
                  <p className="text-sm opacity-60">En attente de joueurs...</p>
                </div>
                <button onClick={onJoined} className="btn btn-primary w-full mt-4">
